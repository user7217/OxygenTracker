...
# Use pymysql driver which is more compatible with PythonAnywhere
default_db_url = 'mysql+pymysql://varasicyl:root@123@varasicyl.mysql.pythonanywhere-services.com/varasicyl$Oxygen'
