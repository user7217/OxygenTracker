# models.py - SQLite database models for PythonAnywhere deployment
import os
...
class Customer(db.Model):
    """Customer model for SQLite database"""
...
class Cylinder(db.Model):
    """Cylinder model for SQLite database"""
...
class RentalHistory(db.Model):
    """Rental history model for SQLite database"""
